...
@section('content')
<form action="{{route('medida.update',compact('medida'))}}" method="POST">
    <div class="form-group">
        <label for="nombre">Nombre </label>
        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="nombre" required value="{{$medida->nombre}}">
    </div>
  ...
  <a href="{{route('medida.index')}}" class="btn btn-danger mb-4" >Cancelar</a>
